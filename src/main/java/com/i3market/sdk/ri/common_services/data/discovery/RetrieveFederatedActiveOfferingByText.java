...
public class RetrieveFederatedActiveOfferingByText {
    public ApiResponse<List<SemanticEngineDataOfferingDto>> getFederatedActiveOfferingByText(String access_token, String id_token, String text, int page, int size, List<String> sort) throws ApiException {
