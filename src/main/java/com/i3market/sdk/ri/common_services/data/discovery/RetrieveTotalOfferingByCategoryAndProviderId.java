...
public class RetrieveTotalOfferingByCategoryAndProviderId {

    private static final Logger _log = LoggerFactory.getLogger(RetrieveOfferingTemplate.class);

    public ApiResponse<List<BigDecimal>> getTotalOfferingByCategoryAndProviderId(String category, String providerId) throws ApiException {
