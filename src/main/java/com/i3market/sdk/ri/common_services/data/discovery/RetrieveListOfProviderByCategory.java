...
public class RetrieveListOfProviderByCategory {
    // GetProviderList function is not available in the Lib Model
    public ApiResponse<List<OfferingsList>> getDataOfferingList(Integer page, Integer size, List<String> sort) throws ApiException {
        ...
        return  registrationOfferingApi.get(page, size, sort);
