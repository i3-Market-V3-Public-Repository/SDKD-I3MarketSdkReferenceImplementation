...
public class CommonServicesEndpoints {
	...
	public static Response getAuthToken() {
	    ...
	    Response response=RestAssured.
	         ...
	         body("grant_type=password&client_id=SDKGeneratorClient&client_secret=XXXXXXXXXXXXXXXXXXXXXXXXXXXX&scope=openid&username=XXXXXXXXXXXXXXXXXXX&password=XXXXXXXXXXXXXXXXXXXXXXXXXXXXX").
